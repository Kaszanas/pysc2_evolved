...
def pysc2_create_external_repos(pysc2_repo_name):
    ...
    Args:
        pysc2_repo_name: The name of the PySC2 repo, as instantiated in
          the local WORKSPACE. When executing this function from the pysc2_evolved
          WORKSPACE, this name is "pysc2_evolved". But external consumers shouldn't
          use that name as it leads to Python import problems due to the
          pysc2_evolved/pysc2_evolved subdirectory. Hence a name such as "pysc2_archive"
          is recommended.
