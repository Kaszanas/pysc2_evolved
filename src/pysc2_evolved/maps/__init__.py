...
from pysc2_evolved.maps import ladder as ladder
from pysc2_evolved.maps import lib as lib
from pysc2_evolved.maps import melee as melee
from pysc2_evolved.maps import mini_games as mini_games
