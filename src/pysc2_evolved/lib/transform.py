...
class Transform(object):
    ...
    def fwd_dist(self, dist: int | float):
        raise NotImplementedError()

    def fwd_pt(self, pt: point.Point) -> point.Point:
        raise NotImplementedError()

    def back_dist(self, dist: int | float) -> float:
        raise NotImplementedError()

    def back_pt(self, pt: point.Point) -> point.Point:
        raise NotImplementedError()
...
class Linear(Transform):
    ...
    def __init__(
        self,
        scale: point.Point | float | None = None,
        offset: point.Point | None = None,
    ):
        if scale is None:
    ...
    def fwd_dist(self, dist: int | float) -> float:
