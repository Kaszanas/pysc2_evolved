...
std::array<int, 787> kUnitsList = {{
    ...
    Zerg::LocustMPPrecursor,  // 799,
    Terran::ThorAALance,  // 807,
    Protoss::TempestWeaponGround,  // 809,
    ...
    Zerg::LurkerEgg,  // 910,
    Protoss::SentryGunUnderground,  // 922,
    Protoss::SentryGun,  // 923,
    ...
    Terran::NukeSiloNova,  // 1025,
    Zerg::BroodLordEgg,  // 1062,
    Zerg::MutaliskEgg,  // 1075,
