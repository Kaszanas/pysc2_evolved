...
#include "pysc2_evolved/env/converter/cc/check_protos_equal.h"
...
pysc2_evolved::Observation MakePlayerObservation() {
  pysc2_evolved::Observation player_observation;
